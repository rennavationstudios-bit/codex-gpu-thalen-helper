...
| LAN exposure | Loopback URI validation, forced host env, listener verification before requests and generation | Another local process can bind/impersonate the port between checks |
